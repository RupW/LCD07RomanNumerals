...
{
    [TestClass]
    public class RomanNumerals1Test : RomanNumeralsTestBase<RomanNumerals1> { }

    [TestClass]
    public class RomanNumerals2Test : RomanNumeralsTestBase<RomanNumerals2> { }

    public class RomanNumeralsTestBase<T> where T : IRomanNumerals, new()
    {
